        ...
        <form wire:submit="submit">
            ...
            <div class="flex items-center justify-end">
                ...
                >
                    ...
                    <span  wire:target="submit" wire:loading.class.remove="hidden" class="hidden">{{ __('Submiting ...') }}</span>
                    <svg  wire:target="submit" wire:loading.class.remove="hidden" aria-hidden="true" class="hidden w-4 h-4 text-gray-50 animate-spin dark:text-gray-600 fill-indigo-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
